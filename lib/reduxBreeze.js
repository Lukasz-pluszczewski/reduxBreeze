(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('react-redux'), require('perfect-immutable'), require('redux')) :
	typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'react-redux', 'perfect-immutable', 'redux'], factory) :
	(factory((global['redux-breeze'] = {}),global._,global.reactRedux,global.perfectImmutable,global.redux));
}(this, (function (exports,_,reactRedux,perfectImmutable,redux) { 'use strict';
 ...
 */
var getValue = function getValue(target, field, throwError, defaultValue) {
  if (throwError) {
    return target[field];
  }
 ...
 * @return {any} requested value
 */
var get = function get(target, path, throwError, defaultValue) {
  if (!_.isArray(path) && !_.isPlainObject(path) && !_.isString(path)) {
    throw new Error('Path passed to get function must be a string, array of strings and numbers or plain object but it\'s type is ' + (typeof path === 'undefined' ? 'undefined' : _typeof(path)));
  }
 ...
 * @return {any} requested value
 */
var getValueForMapStateToProps = function getValueForMapStateToProps(key, state, path, throwError, defaultValue) {
  if (_.isString(path)) {
...
var connect$1 = function connect$$1(mapState) {
  ...
  return reactRedux.connect.apply(undefined, [getNewMapState(mapState)].concat(rest));
};
      ...
      default: function _default(actionDefinition, actionName, initialState) {
        return function () {
          ...
          if (action.type === createActionType(actionName)) {
            return perfectImmutable.set(state, getResultsAssignments(actionDefinition, actionName, action, state));
          }
          return state;
        };
      }
...
var createReduxBreezeInstance$1 = function createReduxBreezeInstance(actionDefinitions) {
  ...
  var createInitialState = function createInitialState(actions) {
    ...
    return _.reduce(actions, function (actionsState, actionDefinition, actionName) {
      if (plugin.initialStateAdapter[actionDefinition.type]) {
        return perfectImmutable.set(actionsState, plugin.initialStateAdapter[actionDefinition.type](actionDefinition, actionName));
      }
      return actionsState;
    }, initialState);
  };
...
exports.chainReducers = chainReducers;
exports.checkConflicts = checkConflicts;
exports.connect = connect$1;
exports.createActionType = createActionType;
exports.mergePlugins = mergePlugins;
exports.defaultPlugin = createDefaultPlugin;
exports.tools = tools;
exports['default'] = createReduxBreezeInstance$1;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=reduxBreeze.js.map
