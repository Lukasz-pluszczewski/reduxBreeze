...
export { chainReducers, checkConflicts, connect$1 as connect, createActionType, mergePlugins, createDefaultPlugin as defaultPlugin, tools };
export default createReduxBreezeInstance$1;
